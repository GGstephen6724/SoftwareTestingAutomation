...
public class Fork extends BaseTest {
    ...
    @Test(priority = 1 )
    // Create githubtests.Fork with other repository
    public void test1_createFork() throws InterruptedException {
        ...
        // Try clicking "githubtests.Fork" or fallback to "View existing forks"
        try {
            Thread.sleep(2000);
            ...
            try {
                ...
                System.out.println("Neither 'githubtests.Fork' nor 'View existing forks' found");
                return;
            }
        }
        ...
        // Click Create githubtests.Fork button
        try {
            Thread.sleep(2000);
    ...
    public void test2_validateForkSuccess() {
        ...
        try {
            ...
            System.out.println("githubtests.Fork verification elements not found.");
        }
    }
    ...
    public void test2_leaveForkNetwork() throws InterruptedException {
        ...
        // Leave githubtests.Fork Network
