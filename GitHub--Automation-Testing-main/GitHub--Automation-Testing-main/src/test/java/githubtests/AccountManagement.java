...
public class AccountManagement extends BaseTest {
    ...
    // Prevents this class from running before the githubtests.Login class finishes
    ...
    public void setStatus() throws InterruptedException {
        ...
        WebElement profileAvatar = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div[1]/header/div/div[2]/div[4]/deferred-side-panel/include-fragment/react-partial-anchor/button/span/span/img")
        ));
        profileAvatar.click();
    ...
    public void changeNameEmailBio() throws InterruptedException {
        ...
        ((JavascriptExecutor) BaseTest.driver).executeScript("arguments[0].scrollIntoView(true);", bioTextArea);
        Thread.sleep(1000);
    ...
    public void checkboxesAndRadios() throws InterruptedException {
        ...
        scrollBy(js, 150);
        BaseTest.driver.findElement(By.id("user_animated_images_enabled")).click();
        Thread.sleep(800);
        BaseTest.driver.findElement(By.id("user_animated_images_disabled")).click();
        Thread.sleep(800);
        BaseTest.driver.findElement(By.id("user_animated_images_system")).click();
        Thread.sleep(1000);

        // Link Underlines, radio buttons
        scrollBy(js, 100);
        BaseTest.driver.findElement(By.id("user_link_underlines_false")).click();
        Thread.sleep(800);
        BaseTest.driver.findElement(By.id("user_link_underlines_true")).click();
        Thread.sleep(1000);
        ...
        scrollBy(js, 200);
        BaseTest.driver.findElement(By.id("user_paste_url_markdown_false")).click();
        Thread.sleep(800);
        BaseTest.driver.findElement(By.id("user_paste_url_markdown_true")).click();
        Thread.sleep(1000);

        BaseTest.driver.get("https://github.com/");
        Thread.sleep(2000);
    }
